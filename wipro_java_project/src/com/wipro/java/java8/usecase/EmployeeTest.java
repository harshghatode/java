...
public class EmployeeTest {
    ...
    public void setUp() {
        ...
        service.addEmployee(new Employee(1, "Harsh", "IT", 60000, LocalDate.of(2020, 5, 10)));
        service.addEmployee(new Employee(2, "Parth", "HR", 50000, LocalDate.of(2019, 3, 15)));
        service.addEmployee(new Employee(3, "Prathamesh", "Finance", 60000, LocalDate.of(2021, 8, 22)));
    }
    ...
    public void testAddDuplicateEmployee() {
        Employee duplicateEmp = new Employee(1, "Harsh", "IT", 60000, LocalDate.of(2020, 5, 10));
        ...
        assertEquals(1, count); // There should only be one "Harsh"
    }
